...
"""
NEW Demo File that Runs with LionDPM
"""
import os
import clip
import torch
...
#model_config = './config/airplane_prior_cfg.yml'
...
for i in range(1, 1000):
    ...
    pts = output['points']
    img_name = f'results/object_{object_type}_steps_{config.ddpm.dpm_step}_e{i}.png'
